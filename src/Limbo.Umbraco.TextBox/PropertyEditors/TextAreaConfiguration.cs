...
namespace Limbo.Umbraco.TextBox.PropertyEditors {
    ...
    public class TextAreaConfiguration {
        ...
        /// </summary>
        [ConfigurationField("maxChars", "Maximum allowed characters", "/App_Plugins/Limbo.TextBox/Views/TextAreaMaxLength.html", Description = "If empty - no character limit.")]
        public int? MaxChars { get; set; }

        /// <summary>
        /// Gets or sets the deault number of rows.
        /// </summary>
        [ConfigurationField("rows", "Number of rows", "/App_Plugins/Limbo.TextBox/Views/TextAreaRows.html", Description = "If empty - 10 rows would be set as the default value.")]
